  ...
  return (
    <section className="relative min-h-screen flex items-center font-power-grotesk">
      ...
      <div className="max-w-[800px] mx-auto px-4 text-center mt-9 relative">
        ...
        <p className="text-[#929796] text-[18px] mb-4 font-light">Your Gateway to Passive Income</p>
        <h1 className="text-[74px] leading-tight font-bold text-[#212121] mb-6">
          STAKE YOUR SOL
        </h1>
        <p className="text-[12px] text-[#636161] mb-8 font-light">
